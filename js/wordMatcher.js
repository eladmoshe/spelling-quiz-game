...
class WordMatcher {
   ...
   * @returns {{isCorrect: boolean, firstWrongLetter: number}} Object containing whether the word is correct and the index of first wrong letter
   */
  checkWord(userAnswer, correctWord) {
